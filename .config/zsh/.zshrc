...
catch_signal_usr2() {
  ...
  histchk=$(tail -1 $ZDOTDIR/.histfile)
  winchk=$(xdotool getactivewindow getwindowname)
  if [ "$histchk" = "cls" ] && [ "$winchk" = "mediumctl" ]; then
...
alias lsf="/bin/ls --quoting-style=literal -nphq --time-style=iso --color=auto --group-directories-first --show-control-chars"
alias lsfa="lsf -A"
...
alias ":q"='exit'
alias ":Q"='exit'
alias gitpom='ghpwd && git push origin master'
